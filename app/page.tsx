  ...
  <div className="absolute inset-0 bg-black bg-opacity-50"></div> 
    ...
    <div className="bg-gray-900 text-white min-h-screen flex flex-col z-10">
      ...
      <div className="text-center bg-black bg-opacity-20 z-20 rounded-xl p-8">
          ...
          <button className="inline-block mt-8 bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-full text-xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110" type="button" onClick={() => router.push('/login')}>
            Connectez vous !
          </button>
          <button className="inline-block mt-8 bg-red-500 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-full text-xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110" type="button" onClick={() => router.push('/register')}>
            Créer un compte !
          </button>
        </div>
